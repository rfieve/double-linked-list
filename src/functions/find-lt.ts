...
/**
 * Finds all nodes lesser than given element into the given double linked list with the given compare function.
...
/**
 * Creates a find lesser function for the given double linked list with the given compare function.
 * @param compare The compare function.
