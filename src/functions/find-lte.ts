...
/**
 * Finds all nodes lesser or equal than given element into the given double linked list with the given compare function.
...
/**
 * Creates a find lesser or equal function for the given double linked list with the given compare function.
 * @param compare The compare function.
